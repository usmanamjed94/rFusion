...
return false;if(typeof event.MSPOINTER_TYPE_MOUSE!=='undefined'&&event.pointerType!=event.MSPOINTER_TYPE_MOUSE)
return true;if(event.pointerType!='mouse')
...
{quitLightbox();return this;};return this;};})(jQuery,window,document);(function($){"use strict";$(function()
{$('a').imageLightbox();});})(jQuery);